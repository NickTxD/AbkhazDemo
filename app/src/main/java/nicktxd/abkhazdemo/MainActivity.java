...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if(checkSelfPermission(Manifest.permission.INTERNET) != PackageManager.PERMISSION_GRANTED) {
                Toast.makeText(this, "Need internet perm", Toast.LENGTH_LONG).show();
                finish();
            }
        }
        init();
    ...
    void init(){
        ...
        ListView listOfVacants = findViewById(R.id.listOfVacancies);
        ArrayAdapter adapter = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, 0);
        listOfVacants.setAdapter(adapter);

        final SwipeRefreshLayout mSwipeRefreshLayout = findViewById(R.id.swipeRefreshVacants);
